...
// #error "lv_conf.h is not intended to be edited directly. Please use lv_conf_internal.h instead."
#ifndef LV_CONF_H
#define LV_CONF_H

#define LV_USE_PRIVATE_API 1
#define LV_USE_VIEWPAGER   1
 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE  LV_FONT_DECLARE(HarmonyOS_Sans_SC_Regular_16)

/*Always set a default font*/
#define LV_FONT_DEFAULT &HarmonyOS_Sans_SC_Regular_16
