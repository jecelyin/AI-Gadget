...
static const uint8_t st7701_type8_init_operations[] = {
    ...
    WRITE_C8_D8, 0xB0, 0x45,

    WRITE_C8_D8, 0xB1, 0x41,
    ...
    WRITE_C8_D8, 0xB8, 0x23,

    WRITE_C8_D8, 0xC0, 0x07,
   ...
   // WRITE_COMMAND_8, 0x20,   // 0x20 normal, 0x21 IPS
    ...
    DELAY, 120,
    WRITE_COMMAND_8, 0x29, // Sleep Out
    DELAY, 120,
    END_WRITE,};
...
static const uint8_t st7701_type9_init_operations[] = {
    ...
    WRITE_COMMAND_8, 0xe0, // Positive Voltage Gamma Control
    WRITE_BYTES, 3,
    0x00, 0x00, 0x02,
